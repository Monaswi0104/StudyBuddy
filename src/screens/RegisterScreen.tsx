...
export const RegisterScreen = () => {
  ...
  return (
    ...
    >
      <ScrollView
        contentContainerStyle={[styles.container, { paddingTop: insets.top + 14, paddingBottom: insets.bottom + 20 }]}
        ...
        <Animated.View style={[styles.headerSection, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
          <View style={styles.headerIconRow}>
            ...
            <View style={styles.headerTextBlock}>
              ...
              <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Join thousands of learners</Text>
            </View>
          </View>
        </Animated.View>

        {/* Benefits strip */}
        <Animated.View style={[styles.benefitsRow, { opacity: fadeAnim }]}>
          {['AI Flashcards', 'Smart Quizzes', 'Mind Maps'].map((benefit, i) => (
            <View key={i} style={[styles.benefitChip, { backgroundColor: isDarkMode ? colors.surface : '#F0F0FF' }]}>
              <CheckCircle2 color="#4F46E5" size={14} />
